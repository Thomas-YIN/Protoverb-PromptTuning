...
class ProtoVerbClassificationRunner(BaseRunner):
    ...
    def __init__(self,
        ...
        # dataloader used to fill template with ground truth label word
        self.train_dataloader_with_label = train_dataloader_with_label
    ...
    def on_fit_start(self):
        ...
        self.inner_model.verbalizer.init_proto(self.model, self.train_dataloader_with_label, self.config.environment.local_rank)
